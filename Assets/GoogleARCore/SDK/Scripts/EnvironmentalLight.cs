...
namespace GoogleARCore
{
    ...
    public class EnvironmentalLight : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            text.text = Frame.LightEstimate.PixelIntensity.ToString();



            if (Frame.LightEstimate.PixelIntensity < 0.41f)
            {
                building.EnableKeyword("_EMISSION");
                scraper.EnableKeyword("_EMISSION");
            }
            else
            {
                building.DisableKeyword("_EMISSION");
                scraper.DisableKeyword("_EMISSION");
            }
